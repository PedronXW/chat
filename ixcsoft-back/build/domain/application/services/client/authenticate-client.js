...
var authenticate_client_exports = {};
__export(authenticate_client_exports, {
  AuthenticateClientService: () => AuthenticateClientService
});
module.exports = __toCommonJS(authenticate_client_exports);
...
var AuthenticateClientService = class {
  constructor(clientRepository, hashComparer, encrypter) {
