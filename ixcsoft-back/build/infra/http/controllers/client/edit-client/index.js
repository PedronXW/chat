...
var clientsRepository = new MongoClientRepository(mongoConnection);
...
var editClientZodBodySchema = import_zod2.z.object({
  name: import_zod2.z.string(),
  email: import_zod2.z.string().email()
});
var editClientZodParamsSchema = import_zod2.z.object({
